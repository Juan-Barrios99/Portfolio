      ...
      <div className="max-w-6xl mx-auto px-8">
        ...
        <section className="pb-32">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-stretch">
            ...
            <Link
              href="/Proyectos/End-to-End-Sales-ETL-Pipeline"
              className="h-full"
            >


              <article className="bg-white border-l-4 border-green-600 rounded-xl p-8 hover:shadow-xl transition cursor-pointer h-full">
                ...
                <p className="text-lg uppercase tracking-widest text-green-700 font-semibold mb-5">
                ...
                <p className="text-gray-600 text-justify">
                  ...
                  Data engineering project focused on building an end-to-end
                  ETL pipeline using Python and PostgreSQL. The workflow
                  extracts sales data, performs data cleaning and
                  transformation processes, and loads the final dataset into
                  a relational database using SQLAlchemy.
